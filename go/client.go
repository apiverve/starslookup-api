// Package starslookup provides a Go client for the Stars Lookup API.
//
// For more information, visit: https://apiverve.com/marketplace/starslookup?utm_source=go&utm_medium=readme
package starslookup
...
const (
	baseURL        = "https://api.apiverve.com/v1/starslookup"
	defaultTimeout = 30 * time.Second
)

// Client is the Stars Lookup API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Stars Lookup API client.
...
// Execute makes a request to the Stars Lookup API with typed parameters.
//
...
//   - name (required): string - The name of the star for which you want to get the data (e.g., Sirius)
