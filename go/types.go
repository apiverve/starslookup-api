...
// Request contains the parameters for the Stars Lookup API.
//
// Parameters:
...
// ResponseData contains the data returned by the Stars Lookup API.
type ResponseData struct {
	StarName string `json:"starName"`
	Mass int `json:"mass"`
	Diameter int `json:"diameter"`
	GalX float64 `json:"galX"`
	GalY float64 `json:"galY"`
	GalZ float64 `json:"galZ"`
