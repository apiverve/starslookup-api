...
```gradle
dependencies {
    implementation 'com.github.apiverve:starslookup-api:1.1.13'
}
```
...
```java
import com.apiverve.starslookup.StarsLookupAPIClient;
import com.apiverve.starslookup.APIResponse;
import com.apiverve.starslookup.APIException;

// Initialize the client
StarsLookupAPIClient client = new StarsLookupAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("name", "Sirius");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/starslookup](https://docs.apiverve.com/ref/starslookup)
...
- **Documentation:** [https://docs.apiverve.com/ref/starslookup](https://docs.apiverve.com/ref/starslookup)
- **Issues:** [GitHub Issues](https://github.com/apiverve/starslookup-api/issues)
